...
//scondScreen()
class saveAgain extends StatefulWidget {
  
  String lname;
  String fname;
  String phone;
 
  saveAgain({Key key,this.fname,this.lname,this.phone}):super(key:key);
 
  @override
  _saveAgainState createState() => _saveAgainState();
}

class _saveAgainState extends State<saveAgain> {
  ...
  Widget build(BuildContext context) {
         ...
         return WillPopScope(
           ...
           appBar: new AppBar(
            ...
            color: Colors.black54,onPressed: ()=>backPressed()),
